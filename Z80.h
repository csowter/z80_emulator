...
private:
  ...
  void RET_NZ(void);
  void POP_BC(void);
  void JP_NZ_word(void);
  void JP_word(void);
  void CALL_NZ_word(void);
  void PUSH_BC(void);
  ...
  void JP_Z_word(void);
  void CB(void);
  void CALL_Z_word(void);
  void CALL_word(void);
  void ADC_A_byte(void);
  void RST_08(void);
  void RET_NC(void);
  void POP_DE(void);
  void JP_NC_word(void);
  void OUT_iNN_A(void);
  void CALL_NC_word(void);
  void PUSH_DE(void);
  ...
  void JP_C_word(void);
  void IN_A_iNN(void);
  void CALL_C_word(void);
  void DD(void);
  void SBC_A_byte(void);
  void RST_18(void);
  void RET_PO(void);
  void POP_HL(void);
  void JP_PO_word(void);
  void EX_iSP_HL(void);
  void CALL_PO_word(void);
  void PUSH_HL(void);
  void AND_byte(void);
  void RST_20(void);
  void RET_PE(void);
  void JP_iHL(void);
  void JP_PE_word(void);
  void EX_DE_HL(void);
  void CALL_PE_word(void);
  void ED(void);
  void XOR_byte(void);
  void RST_28(void);
  void RET_P(void);
